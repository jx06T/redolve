...
import { Filter, PenTool, Highlighter, Layers, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <aside className="w-full lg:w-72 bg-white dark:bg-[#202023] border border-[#E5E7EB] dark:border-[#2C2C30] rounded-3xl p-4 lg:p-5 space-y-4 lg:space-y-6 shrink-0 transition-all">
      ...
      <div className="flex lg:hidden items-center justify-between">
        <button
          ...
          className="w-full flex items-center justify-between text-xs font-semibold text-[#374151] dark:text-[#D1D5DB]"
        >
      ...
      {/* Main Content (Always visible on desktop lg:, collapsible on mobile) */}
