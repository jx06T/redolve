        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              disabled={isSyncing}
              className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-stone-100 dark:bg-stone-800 hover:bg-stone-200 dark:hover:bg-stone-700 text-[#374151] dark:text-[#D1D5DB] border border-stone-200 dark:border-stone-700 transition-all active:scale-95"
