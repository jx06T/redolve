      ...
      {isVisible ? (
        <>
          ...
          {!readOnly && inkVisible && (isErasingLive || (isHoveringEraser && (isEraserActive || activeTool === 'eraser'))) && eraserCursorPos && (
            <div
              className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full border border-status-eraser/70 bg-status-eraser/15 transition-none z-20"
              style={{
